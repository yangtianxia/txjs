...
export function makeNumberMap<T = string[]>(keys: (keyof T)[]): Record<keyof T, number | undefined>
export function makeNumberMap<U extends number, T = string[]>(keys: (keyof T)[], iteratee: (key: keyof T) => U): Record<keyof T, U>
export function makeNumberMap<U extends number | undefined, T = string[]>(keys: (keyof T)[], iteratee?: (key: keyof T) => U) {
