...
export function makeStringMap<T = string[]>(
  keys: (keyof T)[]
): Record<keyof T, string | undefined>
export function makeStringMap<U extends string, T = string[]>(
  keys: (keyof T)[],
  iteratee: (key: keyof T) => U
): Record<keyof T, U>
export function makeStringMap<U extends string | undefined, T = string[]>(
  keys: (keyof T)[],
  iteratee?: (key: keyof T) => U
) {
